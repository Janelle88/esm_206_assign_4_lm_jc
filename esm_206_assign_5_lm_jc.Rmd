...
Based on these results, there is an observed association between where salamanders are found depending on whether or not they are in a clear cut or old growth section of Mack Creek (p `r p_val_chi`)
